...
uint256 hashGenesisBlock("0xc7ac09fb7b9a70688dfb9de48e1971e6b10150e8bdb0ace826cfa77591f411e7");
...
const string strMessageMagic = "YourCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // YourCoin: 1 days
static const int64 nTargetSpacing = 120; // YourCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal YourCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "YourCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8c7b3042193389c90606bf3fc62abaa0478648e6b286c3594fc97901b78a9584");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1402009162";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1402099203; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 564128;

        if (fTestNet)
        {
            block.nTime    = 1402009162;
            block.nNonce   = 1030222;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x868b740285da1f6e2b4d44d855f846b1b328a28dc786c9fc28492743f7ba5413"));
